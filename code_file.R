### Data Import
assignment <- read.csv("upload your file location here")
### View Dataset
View(assignment)
...
## Analysing "HOW DOES THE STUDENT’S ATTENDANCE AFFECT THEIR OUTPUT GRADE?"
...
## Analysing "HOW DOES STUDENT’S TAKING NOTES AFFECT THEIR OUTPUT GRADE?"
...
## Analysing "HOW DOES READING JOURNALS CAN AFFECT STUDENT'S GRADES?"
...
## EXTRA FEATURES; added for understanding the relation between data more deeply
